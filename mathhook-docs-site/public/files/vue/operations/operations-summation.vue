<template>
  <div class="doc-page">
    <header class="doc-header">
      <h1>Summation and Products</h1>
      <p class="description">Symbolic summation and products in MathHook provide closed-form formulas for arithmetic series, geometric series, power sums, and convergence analysis for infinite series.
</p>
    </header>
    ...
    <section class="math-definition">
      ...
      <div class="katex-block">**Arithmetic Series:**
...
\end{cases}$$
    ...
    <section class="examples">
      ...
      <div class="example-card">
        <h3>Arithmetic Series (Gauss's Formula)</h3>
        <p>Sum of integers from 1 to n</p>
...
println!("{}", sum);  // 55
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">from mathhook import arithmetic_series
...
print(sum_integers)  # 55
        ...
        <div v-show="activeTab === 'javascript'" class="code-block">
          <pre><code class="language-javascript">const { arithmeticSeries } = require('mathhook');
...
println!("{}", sum);  // 7/4 (exact rational)
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">from mathhook import geometric_series
...
print(sum_halves)  # 1.75
        ...
        <div v-show="activeTab === 'javascript'" class="code-block">
          <pre><code class="language-javascript">const { geometricSeries } = require('mathhook');
...
println!("{}", sum);  // 3/2 (exact rational)
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">from mathhook import infinite_geometric_series
...
print(sum_thirds)  # 1.5
        ...
        <div v-show="activeTab === 'javascript'" class="code-block">
          <pre><code class="language-javascript">const { infiniteGeometricSeries } = require('mathhook');
...
console.log(sumThirds.toString());  // 3/2
      ...
      <div class="example-card">
        <h3>Power Sums (Nicomachus's Theorem)</h3>
        <p>Sum of cubes equals square of sum</p>
...
println!("{}", sum);  // 100 (1 + 8 + 27 + 64 = 10^2)
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">from mathhook import power_sum
...
print(sum_integers ** 2)  # 225 (15^2)
        ...
        <div v-show="activeTab === 'javascript'" class="code-block">
          <pre><code class="language-javascript">const { powerSum } = require('mathhook');
...
// SEO metadata
const metaDescription = "Symbolic summation and products in MathHook provide closed-form formulas for arithmetic series, geometric series, power sums, and convergence analysis for infinite series.
"
const keywords = []

// Define page metadata
definePageMeta({
  title: 'Summation and Products',
