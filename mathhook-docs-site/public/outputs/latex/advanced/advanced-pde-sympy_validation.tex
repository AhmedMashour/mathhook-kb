...
\title{ SymPy Validation Workflow }
\author{MathHook CAS}
\date{\today}
...
\subsection{ Heat Equation Validation }
...
\subsection{ Eigenvalue Scaling Validation }
...
\subsection{ Wave Equation Frequency Validation }
