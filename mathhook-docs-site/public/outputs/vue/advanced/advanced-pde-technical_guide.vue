<template>
  <div class="doc-page">
    <header class="doc-header">
      <h1>PDE Technical Guide - Mathematical Foundation and Implementation</h1>
      <p class="description">Rigorous mathematical treatment of partial differential equations with proofs and references.
...
groundwater contaminant transport). Includes complete derivations and MathHook implementation details.
    ...
    <section class="math-definition">
      ...
      <div class="katex-block">**Definition (Quasi-Linear First-Order PDE)**:
...
$$f'(u_L) > s > f'(u_R)$$
    ...
    <section class="examples">
      ...
      <div class="example-card">
        <h3>Transport Equation (Complete Derivation)</h3>
        <p>Rigorous derivation of transport equation solution using method of characteristics</p>
        ...
        <div v-show="activeTab === 'rust'" class="code-block">
          <pre><code class="language-rust">/// Transport equation: ∂u/∂t + c·∂u/∂x = 0 with u(x,0) = sin(x)
///
...
fn main() {
    ...
    println!("✓ IC verified: u(x,0) = sin(x)");
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">"""Transport equation: ∂u/∂t + c·∂u/∂x = 0 with u(x,0) = sin(x)
...
console.log("✓ IC verified: u(x,0) = sin(x)");
      ...
      <div class="example-card">
        <h3>Burgers' Equation (Shock Formation Analysis)</h3>
        <p>Demonstrate shock formation in Burgers' equation with Rankine-Hugoniot condition</p>
        ...
        <div v-show="activeTab === 'rust'" class="code-block">
          <pre><code class="language-rust">/// Burgers' equation: ∂u/∂t + u·∂u/∂x = 0
///
/// Demonstrates:
...
fn main() {
    ...
    println!("  u_L = 1 > u_R = 0 → COMPRESSIVE SHOCK ✓");
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">"""Burgers' equation: ∂u/∂t + u·∂u/∂x = 0
...
console.log("  Entropy condition satisfied: u_L > u_R ✓");
      ...
      <div class="example-card">
        <h3>Traffic Flow Model (Lighthill-Whitham-Richards)</h3>
        <p>Real-world application of conservation laws to traffic flow</p>
        ...
        <div v-show="activeTab === 'rust'" class="code-block">
          <pre><code class="language-rust">/// Traffic Flow Model (Lighthill-Whitham-Richards)
///
...
fn main() {
    ...
    println!("  → Traffic jam propagates backward");
        ...
        <div v-show="activeTab === 'python'" class="code-block">
          <pre><code class="language-python">"""Traffic Flow Model (Lighthill-Whitham-Richards)
...
// SEO metadata
const metaDescription = "Rigorous mathematical treatment of partial differential equations with proofs and references.
Covers formal definitions, method of characteristics with geometric interpretation, existence
and uniqueness theory (Cauchy-Kovalevskaya theorem), nonlinear PDEs, shock formation, weak
solutions, Rankine-Hugoniot jump conditions, and real-world applications (traffic flow,
groundwater contaminant transport). Includes complete derivations and MathHook implementation details.
